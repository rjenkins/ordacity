...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"ordacity\" -DPACKAGE_TARNAME=\"ordacity\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"ordacity\ 0.1\" -DPACKAGE_BUGREPORT=\"ray@boundary.com\" -DPACKAGE=\"ordacity\" -DVERSION=\"0.1\" -DHAVE_LIBM=1
DEPDIR = .deps
ECHO_C = \c
ECHO_N = 
ECHO_T = 
